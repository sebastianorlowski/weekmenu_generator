...
public class RecipeDtoValidationMessage {
    ...
    public static final String RECIPE_TYPE_REQUIRED_ERROR = "The type of recipe is required.";
    public static final String RECIPE_TYPE_PATTERN_ERROR = "The recipe type must match breakfast, lunch, dinner, evening_meal.";
    ...
    public static final String RECIPE_TYPE_REGEX_PATTERN = "BREAKFAST|LUNCH|DINNER|EVENING_MEAL";
}
